...
inDirName = '/storage/home/hcoda1/6/smurugan9/data/sparsepca/'
...
eofs.to_netcdf(inDirName+resultsDir+"a001_eofs.nc")
pcs.to_netcdf(inDirName+resultsDir+"a001_pcs.nc")
...
for i in range(n_realizations):
    ...
    sparse_mini_rand.to_netcdf(inDirName+resultsDir+"spca_a001_REC{}.nc".format(i))
