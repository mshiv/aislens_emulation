...
# Dedrafted flux
flux_dedrafted = xr.open_dataset(inDirName+interim_data_folder+flux_dedrafted_iceshelves_data_path+'iceshelves_dedrafted_total.nc')
...
cutoff_period_list = [60,120,180,12,24]
...
for cutoff_period in cutoff_period_list:
	...
	flux_clean_filtered.to_netcdf(inDirName+interim_data_folder+cise_file_path+std_file_path+temp_filtered_path+"filtered_{}.nc".format(cutoff_period))
	flux_reconstr_noise.to_netcdf(inDirName+interim_data_folder+cise_file_path+std_file_path+temp_filtered_path+"filtnoise_{}.nc".format(cutoff_period))
	...
	eofs.to_netcdf(inDirName+interim_data_folder+cise_file_path+std_file_path+temp_filtered_path+"filteofs_{}.nc".format(cutoff_period))
	pcs.to_netcdf(inDirName+interim_data_folder+cise_file_path+std_file_path+temp_filtered_path+"filtpcs_{}.nc".format(cutoff_period))
	varexpl.to_netcdf(inDirName+interim_data_folder+cise_file_path+std_file_path+temp_filtered_path+"filtvarexpl_{}.nc".format(cutoff_period))
