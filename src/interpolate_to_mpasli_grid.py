...
if filetype=='cism':
   ...
   if not args.thicknessOnly:
     ...
     fieldInfo['ismip6shelfMelt_offset'] =    {'InputName':'subm', 'scalefactor':910.0/(3600.0*24.0*365.0), 'offset':0.0, 'gridType':'x1', 'vertDim':False}  # Assuming default CISM density
